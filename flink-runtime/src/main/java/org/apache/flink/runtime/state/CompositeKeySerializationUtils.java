...
public class CompositeKeySerializationUtils {
    ...
    public static <N> void writeNameSpace(
        ...
        // If the passed namespaceSerializer does not match the namespace, it should not serialize
        // and should not write backendState
        // Sharing state between trigger and TimeWindow causes inconsistencies in the namespace and
        // NamespaceSerializer
